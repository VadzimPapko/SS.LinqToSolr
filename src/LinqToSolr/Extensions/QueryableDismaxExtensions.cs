...
namespace SS.LinqToSolr.Extensions
{
    ...
    {
        public static IQueryable<T> Dismax<T>(this IQueryable<T> source, Expression<Func<IQueryable<T>, IQueryable<T>>> keySelector)
        {
            if (source == null)
        ...
        public static IQueryable<T> DismaxQuery<T, TKey>(this IQueryable<T> source, string value)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            return source.Provider.CreateQuery<T>(Expression.Call(null,
        ...
        /// q.alt
        /// </summary>        
        public static IQueryable<T> DismaxQueryAlt<T>(this IQueryable<T> source, Expression<Func<IQueryable<T>, IQueryable<T>>> keySelector)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (keySelector == null)
        ...
        /// bq
        /// </summary>        
        public static IQueryable<T> BoostQuery<T>(this IQueryable<T> source, Expression<Func<IQueryable<T>, IQueryable<T>>> keySelector)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (keySelector == null)
